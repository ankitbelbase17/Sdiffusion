...
COMMAND = ['python', str(EVAL_SCRIPT), '--checkpoint', '__CKPT_PATH__', '--curvton_test_data_path', '/iopsstor/scratch/cscs/dbartaula/human_gen/dataset_v3_backup_1/dataset_ultimate_test', '--batch_size', '16', '--num_workers', '8', '--eval_frac_curvton', '0.80', '--curvton_splits', 'easy,medium,hard', '--image_size', '0', '--num_inference_steps', '30', '--triplet_test_data_path', '', '--street_tryon_data_path', '']
