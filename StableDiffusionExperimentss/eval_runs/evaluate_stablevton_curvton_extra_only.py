#!/usr/bin/env python3
from evaluate_stablevton_curvton import main as _main, COMMAND
...
COMMAND[:] = [
    ...
    "--output_json",
    "/iopsstor/scratch/cscs/dbartaula/experiments_assets_1/train_stable_vton/eval_metrics_curvton_extra_only.json",
]
