...
COMMAND = ['python', str(EVAL_SCRIPT), '--checkpoint', '__CKPT_PATH__', '--curvton_test_data_path', '/iopsstor/scratch/cscs/dbartaula/human_gen/dataset_v3_backup_1/dataset_ultimate_test', '--batch_size', '16', '--num_workers', '8', '--eval_frac_curvton', '0.80', '--eval_frac_curvton_overall', '0.25', '--triplet_test_data_path', '']
def _latest_ckpt(ckpt_dir: Path) -> Path:
    target_ckpt = ckpt_dir / "ckpt_step_12000.pt"
