...
COMMAND = ['python', 'custom_model_pretraining/evaluate_fid_kid.py', '--approach', 'datapred', '--model_size', '400m', '--checkpoint', '__CKPT_PATH__', '--curvton_test_data_path', '/iopsstor/scratch/cscs/dbartaula/human_gen/dataset_v3_backup_1/dataset_ultimate_test', '--image_size', '64', '--batch_size', '16', '--num_workers', '8', '--diffusion_steps', '50', '--eval_frac_curvton', '0.80', '--eval_frac_curvton_overall', '0.25', '--output_json', '/iopsstor/scratch/cscs/dbartaula/experiments_assets/Stable_diffusion_train_custom_dit_datapred_400m_30000steps/eval_fid_kid.json']
