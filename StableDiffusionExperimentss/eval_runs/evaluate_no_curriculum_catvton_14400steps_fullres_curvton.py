...
CKPT_DIR = Path('/iopsstor/scratch/cscs/dbartaula/experiments_assets/Stable_diffusion_train_no_curriculum_catvton_14400steps_fullres/checkpoints')
RUN_NAME = CKPT_DIR.parent.name
COMMAND = ['python', str(EVAL_SCRIPT), '--checkpoint', '__CKPT_PATH__', '--curvton_test_data_path', '/iopsstor/scratch/cscs/dbartaula/human_gen/dataset_v3_backup_1/dataset_ultimate_test', '--batch_size', '16', '--num_workers', '8', '--eval_frac_curvton', '0.80', '--eval_frac_curvton_overall', '0.25', '--curvton_splits', 'easy,medium,hard,overall', '--image_size', '0', '--num_inference_steps', '30', '--triplet_test_data_path', '', '--street_tryon_data_path', '']
